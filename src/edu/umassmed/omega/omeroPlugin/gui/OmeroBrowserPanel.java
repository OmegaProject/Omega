...
public class OmeroBrowserPanel extends GenericPanel {
	...
	private ArrayList<OmeroImageWrapper> toBeOpened = null;

	public ArrayList<OmeroImageWrapper> getToBeOpened() {
	...
	public void setImages(final List<OmeroThumbnailImageInfo> imageInfo) {
		this.toBeOpened = new ArrayList<OmeroImageWrapper>();
		...
		while (iterator.hasNext()) {
			...
			final OmeroBrowserSingleImagePanel singleImagePanel = new OmeroBrowserSingleImagePanel(
			        temp.getImageID(), temp.getImageName(),
			...
			checked.addItemListener(new ItemListener() {
				...
				public void itemStateChanged(final ItemEvent itemEvent) {
					...
					if (state == ItemEvent.SELECTED) {
						OmeroBrowserPanel.this.toBeOpened.add(temp.getImage());
					} else if (state == ItemEvent.DESELECTED) {
						OmeroBrowserPanel.this.toBeOpened.remove(temp
						        .getImage());
					}
				}
			});
