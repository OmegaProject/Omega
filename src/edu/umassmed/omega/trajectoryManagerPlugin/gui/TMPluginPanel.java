...
import edu.umassmed.omega.trajectoryManagerPlugin.actions.TMAction;
import edu.umassmed.omega.trajectoryManagerPlugin.actions.TMAdjustAction;
import edu.umassmed.omega.trajectoryManagerPlugin.actions.TMSegmentAction;
...
public class TMPluginPanel extends GenericPluginPanel {
	...
	final List<OmegaTrajectoriesManagerRun> trajManagerRuns;
	private OmegaTrajectoriesManagerRun selectedTrajManagerRun;
	...
	public TMPluginPanel(final RootPaneContainer parent,
		...
		this.adjustActions = new LinkedHashMap<OmegaAnalysisRun, List<TMAction>>();
		this.cancelledAdjustActions = new LinkedHashMap<OmegaAnalysisRun, List<TMAction>>();
		this.segmentActions = new LinkedHashMap<OmegaAnalysisRun, List<TMAction>>();
		this.cancelledSegmentActions = new LinkedHashMap<OmegaAnalysisRun, List<TMAction>>();
		...
		this.trajManagerRuns = new ArrayList<OmegaTrajectoriesManagerRun>();
		this.selectedTrajManagerRun = null;

		this.actualModifiedTrajectories = new ArrayList<OmegaTrajectory>();
	...
	private void selectParticleLinkingRun() {
		...
		final OmegaParameter radius = this.selectedParticleLinkingRun
		        .getAlgorithmSpec().getParameter(
		                OmegaAlgorithmParametersConstants.PARAM_RADIUS);
		if ((radius != null)
	...
	private void fireTMPluginTrajectoriesManagerRunSelectionEvent() {
		final OmegaPluginEvent event = new OmegaTMPluginTrajectoriesManagerRunSelectionEvent(
