...
public class SDQueueRunBrowserPanel extends GenericPanel {
	...
	public SDQueueRunBrowserPanel(final RootPaneContainer parentContainer,
		...
		this.root.setUserObject(SDConstants.RUN_QUEUE);
	...
	private void createAndAddWidgets() {
		...
		scrollPane.setBorder(new TitledBorder(SDConstants.RUN_QUEUE));
	...
	private void addListeners() {
		this.dataTree.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(final MouseEvent event) {
				final TreePath path = SDQueueRunBrowserPanel.this.dataTree
				        .getPathForLocation(event.getX(), event.getY());
				if (path == null) {
					SDQueueRunBrowserPanel.this.sptPanel
					        .updateSelectedImage(null);
					SDQueueRunBrowserPanel.this.deselect();
					return;
				}
				final DefaultMutableTreeNode node = (DefaultMutableTreeNode) path
				        .getLastPathComponent();
				final String s = node.toString();
				final OmegaElement element = SDQueueRunBrowserPanel.this.nodeMap
				        .get(s);
		...
		this.dataTree.getModel().addTreeModelListener(new TreeModelAdapter() {
			...
			public void treeNodesChanged(final TreeModelEvent event) {
				if (SDQueueRunBrowserPanel.this.adjusting)
					return;
				SDQueueRunBrowserPanel.this.adjusting = true;
				...
				SDQueueRunBrowserPanel.this.adjusting = false;
