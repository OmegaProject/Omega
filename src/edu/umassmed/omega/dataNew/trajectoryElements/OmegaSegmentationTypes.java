...
public class OmegaSegmentationTypes extends OmegaNamedElement {
	...
	public static OmegaSegmentationTypes getDefaultSegmentationTypes() {
		...
		final OmegaSegmentationTypes defaultSegType = new OmegaSegmentationTypes(
		        name);
		OmegaSegmentationTypes.createDefaultSegmentationTypes(defaultSegType);
	...
	private static void createDefaultSegmentationTypes(
	        final OmegaSegmentationTypes segmTypes) {
		segmTypes.types.add(OmegaSegmentationTypes.getDefaultNotAssigned());
