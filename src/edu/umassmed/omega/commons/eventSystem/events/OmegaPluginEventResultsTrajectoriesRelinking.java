...
public class OmegaPluginEventResultsTrajectoriesRelinking extends
	...
	public OmegaPluginEventResultsTrajectoriesRelinking(final OmegaElement element,
	        final List<OmegaTrajectory> resultingTrajectories) {
		this(null, element, resultingTrajectories);
	}

	public OmegaPluginEventResultsTrajectoriesRelinking(final OmegaPlugin source,
