...
public class PTLoadedDataBrowserPanel extends GenericPanel {
	...
	public PTLoadedDataBrowserPanel(final RootPaneContainer parentContainer,
		...
		this.root.setUserObject(PLConstants.LOADED_DATA);
	...
	private void createAndAddWidgets() {
		...
		scrollPane.setBorder(new TitledBorder(PLConstants.LOADED_DATA));
