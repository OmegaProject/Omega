...
public class MosaicSNREstimationQueueRunBrowserPanel extends GenericPanel {
	...
	public MosaicSNREstimationQueueRunBrowserPanel(final RootPaneContainer parentContainer,
			final MosaicSNREstimationPluginPanel sptPanel) {
	...
	private void addListeners() {
		this.dataTree.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(final MouseEvent event) {
				MosaicSNREstimationQueueRunBrowserPanel.this.handleMouseClick(event.getPoint());
			}
		});
		this.dataTree.getModel().addTreeModelListener(new TreeModelListener() {
			@Override
			public void treeNodesChanged(final TreeModelEvent event) {
				MosaicSNREstimationQueueRunBrowserPanel.this.handleTreeChanged(event);
			}
	...
	private void handleMouseClick(final Point clickP) {
		final TreePath path = MosaicSNREstimationQueueRunBrowserPanel.this.dataTree
