...
public class MosaicSNREstimationRunPanel extends GenericPanel implements
	...
	public MosaicSNREstimationRunPanel(final RootPaneContainer parent,
	...
	public JScrollPane createSNREstimatorParamPanel() {
		...
		radius_lbl.setPreferredSize(MosaicSNREstimationRunPanel.LBL_FIELDS_DIM);
		radiusPanel.add(radius_lbl);
		this.radius_txtField = new GenericTextFieldValidable(
				GenericTextFieldValidable.CONTENT_INT);
		this.radius_txtField.setPreferredSize(MosaicSNREstimationRunPanel.VALUE_FIELDS_DIM);
		...
		thresh_lbl.setPreferredSize(MosaicSNREstimationRunPanel.LBL_FIELDS_DIM);
		threshPanel.add(thresh_lbl);
		this.threshold_txtField = new GenericTextFieldValidable(
				GenericTextFieldValidable.CONTENT_DOUBLE);
		this.threshold_txtField.setPreferredSize(MosaicSNREstimationRunPanel.VALUE_FIELDS_DIM);
		...
		final JLabel snrMethod_lbl = new JLabel(MosaicSNREstimationPluginConstants.PARAM_SNR_METHOD
				+ ":");
		snrMethod_lbl.setPreferredSize(MosaicSNREstimationRunPanel.LBL_FIELDS_DIM);
		snrMethodPanel.add(snrMethod_lbl);
		this.snrMethod_cmb = new GenericComboBox<String>(
				this.getParentContainer());
		this.snrMethod_cmb.setPreferredSize(MosaicSNREstimationRunPanel.LBL_FIELDS_DIM);
		this.snrMethod_cmb
				.addItem(MosaicSNREstimationPluginConstants.PARAM_SNR_METHOD_BHATTACHARYYA_POISSON);
		this.snrMethod_cmb
				.addItem(MosaicSNREstimationPluginConstants.PARAM_SNR_METHOD_BHATTACHARYYA_GAUSSIAN);
		this.snrMethod_cmb.addItem(MosaicSNREstimationPluginConstants.PARAM_SNR_METHOD_SBALZARINI);
	...
	private JScrollPane createSelectionParamPanel() {
		...
		final JLabel zSectionLbl = new JLabel(
				OmegaAlgorithmParameterConstants.PARAM_ZSECTION
						+ " to analyze:");
		zSectionLbl.setPreferredSize(MosaicSNREstimationRunPanel.LBL_FIELDS_DIM);
		zSectionPanel.add(zSectionLbl);
		this.zSection_txtField = new GenericTextFieldValidable(
				GenericTextFieldValidable.CONTENT_INT);
		this.zSection_txtField.setPreferredSize(MosaicSNREstimationRunPanel.VALUE_FIELDS_DIM);
	...
	public void updateRunFields(final List<OmegaParameter> parameters) {
		for (final OmegaParameter param : parameters) {
			...
			} else if (param.getName().equals(MosaicSNREstimationPluginConstants.PARAM_SNR_METHOD)) {
	...
	public List<OmegaParameter> getParameters() {
		...
		params.add(new OmegaParameter(MosaicSNREstimationPluginConstants.PARAM_SNR_METHOD, snrMethod));
