package edu.umassmed.omega.omegaTrackingMeasuresVelocityPlugin.runnable;
...
import edu.umassmed.omega.omegaTrackingMeasuresVelocityPlugin.gui.OmegaTrackingMeasuresVelocityGraphPanel;

public class OmegaTrackingMeasuresVelocityGraphProducer extends StatsGraphProducer {
	
	private final OmegaTrackingMeasuresVelocityGraphPanel velocityPanel;
	...
	public OmegaTrackingMeasuresVelocityGraphProducer(final OmegaTrackingMeasuresVelocityGraphPanel velocityPanel,
	...
	public String getTitle() {
		...
		switch (this.velocityOption) {
			case OmegaTrackingMeasuresVelocityGraphPanel.OPTION_FORPROLIN:
				title = GraphLabelConstants.GRAPH_NAME_FORPROLIN_GLO;
				break;
			case OmegaTrackingMeasuresVelocityGraphPanel.OPTION_LOCAL_SPEED_P2P:
				title = GraphLabelConstants.GRAPH_NAME_SPEED_P2P_LOC;
				break;
			case OmegaTrackingMeasuresVelocityGraphPanel.OPTION_LOCAL_VELOCITY:
				title = GraphLabelConstants.GRAPH_NAME_VEL_LOC;
				break;
			case OmegaTrackingMeasuresVelocityGraphPanel.OPTION_MEAN_SPEED:
				title = GraphLabelConstants.GRAPH_NAME_SPEED_GLO;
				break;
			case OmegaTrackingMeasuresVelocityGraphPanel.OPTION_MEAN_VELOCITY:
				title = GraphLabelConstants.GRAPH_NAME_VEL_GLO;
				break;
			default:
				title = GraphLabelConstants.GRAPH_NAME_SPEED_LOC;
		}
		return title;
	}
	...
	public String getYAxisTitle() {
		...
		switch (this.velocityOption) {
			case OmegaTrackingMeasuresVelocityGraphPanel.OPTION_LOCAL_VELOCITY:
			case OmegaTrackingMeasuresVelocityGraphPanel.OPTION_MEAN_VELOCITY:
				yAxisTitle = GraphLabelConstants.GRAPH_LAB_Y_VEL;
				break;
			default:
				yAxisTitle = GraphLabelConstants.GRAPH_LAB_Y_SPEED;
		}
		return yAxisTitle;
	}
		...
		if (this.itsLocal) {
			...
			try {
				SwingUtilities.invokeAndWait(new Runnable() {
					@Override
					public void run() {
						OmegaTrackingMeasuresVelocityGraphProducer.this.velocityPanel.updateStatus(
								OmegaTrackingMeasuresVelocityGraphProducer.this.getCompleted(), ended);
					}
				});
