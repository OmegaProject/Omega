 ...
 *******************************************************************************/
package edu.umassmed.omega.omegaTrackingMeasuresVelocityPlugin;
...
import edu.umassmed.omega.omegaTrackingMeasuresVelocityPlugin.gui.OmegaTrackingMeasuresVelocityPluginPanel;

public class OmegaTrackingMeasuresVelocityPlugin extends OmegaTrackingMeasuresPluginArchetype implements
		OmegaDataDisplayerPluginInterface {

	public OmegaTrackingMeasuresVelocityPlugin() {
		super(1);
	}

	public OmegaTrackingMeasuresVelocityPlugin(final int maxNumOfPanels) {
		super(maxNumOfPanels);
	}

	@Override
	public String getName() {
		return OmegaTrackingMeasuresVelocityPluginConstants.PLUGIN_NAME;
	}

	@Override
	public String getShortName() {
		return OmegaTrackingMeasuresVelocityPluginConstants.PLUGIN_SNAME;
	}
	...
	public GenericPluginPanel createNewPanel(final RootPaneContainer parent,
		...
		final OmegaTrackingMeasuresVelocityPluginPanel panel = new OmegaTrackingMeasuresVelocityPluginPanel(parent, this,
	...
	public void setGateway(final OmegaGateway gateway) {
		...
		for (final GenericPluginPanel panel : this.getPanels()) {
			final OmegaTrackingMeasuresVelocityPluginPanel specificPanel = (OmegaTrackingMeasuresVelocityPluginPanel) panel;
	...
	public String getAlgorithmDescription() {
		return OmegaTrackingMeasuresVelocityPluginConstants.PLUGIN_ALGO_DESC;
	}
	...
	public String getAlgorithmVersion() {
		return OmegaTrackingMeasuresVelocityPluginConstants.PLUGIN_VERSION;
	}

	@Override
	public Date getAlgorithmPublicationDate() {
		return OmegaTrackingMeasuresVelocityPluginConstants.PLUGIN_PUBL;
	}

	@Override
	public String getDescription() {
		return OmegaTrackingMeasuresVelocityPluginConstants.PLUGIN_DESC;
	}

	@Override
	public String getReference() {
		return OmegaTrackingMeasuresVelocityPluginConstants.PLUGIN_REFERENCE;
	}
