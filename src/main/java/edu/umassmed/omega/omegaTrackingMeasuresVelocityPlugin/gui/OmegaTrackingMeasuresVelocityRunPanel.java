...
public class OmegaTrackingMeasuresVelocityRunPanel extends GenericPanel implements
	...
	public OmegaTrackingMeasuresVelocityRunPanel(final RootPaneContainer parent,
	...
	private void addListeners() {
		this.run_btt.addActionListener(new ActionListener() {
			...
			public void actionPerformed(final ActionEvent evt) {
				OmegaTrackingMeasuresVelocityRunPanel.this.startVelocityAnalyzer();
			}
		});
	}
