...
public class MosaicFeaturePointDetectionLoadedDataBrowserPanel extends GenericPanel {
	...
	public MosaicFeaturePointDetectionLoadedDataBrowserPanel(final RootPaneContainer parentContainer,
	...
	private void addListeners() {
		this.dataTree.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(final MouseEvent event) {
				MosaicFeaturePointDetectionLoadedDataBrowserPanel.this.handleMouseClick(event.getPoint());
			}
		});
		this.dataTree.getModel().addTreeModelListener(new TreeModelListener() {
			@Override
			public void treeNodesChanged(final TreeModelEvent event) {
				MosaicFeaturePointDetectionLoadedDataBrowserPanel.this.handleTreeChanged(event);
			}
	...
	private void handleMouseClick(final Point clickP) {
		...
		final OmegaElement element = MosaicFeaturePointDetectionLoadedDataBrowserPanel.this.nodeMap
				.get(s);
