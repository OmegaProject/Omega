...
public class OmeroImageBrowserPluginPanel extends OmeroPanel implements
	...
	private final OmeroImageBrowserConnectionDialog connectionDialog;
	private final GenericConfirmationDialog confirmDialog;

	private final OmegaData omegaData;

	public OmeroImageBrowserPluginPanel(final RootPaneContainer parent,
			final OmeroImageBrowserPlugin plugin, final OmeroGateway gateway,
		...
		this.confirmDialog = new GenericConfirmationDialog(
				...
				OmeroImageBrowserPluginPanel.LOADING_WARNING_OMEGA, true);
	...
	private void addListeners() {
		this.connectMItem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(final ActionEvent evt) {
				OmeroImageBrowserPluginPanel.this.showConnectionPanel();
			}
		});
	...
	private void handlePropertyConnection() {
		if (this.getGateway().isConnected()) {
			...
			OmeroImageBrowserPluginPanel.this.getPlugin().fireEvent(
					new OmegaPluginEventGateway(this.getPlugin(),
