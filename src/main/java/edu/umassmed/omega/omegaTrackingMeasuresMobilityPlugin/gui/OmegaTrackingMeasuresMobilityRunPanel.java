...
public class OmegaTrackingMeasuresMobilityRunPanel extends GenericPanel implements
	...
	public OmegaTrackingMeasuresMobilityRunPanel(final RootPaneContainer parent,
	...
	private void addListeners() {
		this.run_btt.addActionListener(new ActionListener() {
			...
			public void actionPerformed(final ActionEvent evt) {
				OmegaTrackingMeasuresMobilityRunPanel.this.startMobilityAnalyzer();
			}
		});
	}
