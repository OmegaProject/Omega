 ...
 *******************************************************************************/
package edu.umassmed.omega.omegaTrackingMeasuresMobilityPlugin;
...
import edu.umassmed.omega.omegaTrackingMeasuresMobilityPlugin.gui.OmegaTrackingMeasuresMobilityPluginPanel;

public class OmegaTrackingMeasuresMobilityPlugin extends OmegaTrackingMeasuresPluginArchetype implements
		OmegaDataDisplayerPluginInterface {

	public OmegaTrackingMeasuresMobilityPlugin() {
		super(1);
	}

	public OmegaTrackingMeasuresMobilityPlugin(final int maxNumOfPanels) {
		super(maxNumOfPanels);
	}

	@Override
	public String getName() {
		return OmegaTrackingMeasuresMobilityPluginConstants.PLUGIN_NAME;
	}

	@Override
	public String getShortName() {
		return OmegaTrackingMeasuresMobilityPluginConstants.PLUGIN_SNAME;
	}
	...
	public GenericPluginPanel createNewPanel(final RootPaneContainer parent,
		...
		final OmegaTrackingMeasuresMobilityPluginPanel panel = new OmegaTrackingMeasuresMobilityPluginPanel(parent, this,
	...
	public void setGateway(final OmegaGateway gateway) {
		...
		for (final GenericPluginPanel panel : this.getPanels()) {
			final OmegaTrackingMeasuresMobilityPluginPanel specificPanel = (OmegaTrackingMeasuresMobilityPluginPanel) panel;
	...
	public String getAlgorithmDescription() {
		return OmegaTrackingMeasuresMobilityPluginConstants.PLUGIN_ALGO_DESC;
	}
	...
	public String getAlgorithmVersion() {
		return OmegaTrackingMeasuresMobilityPluginConstants.PLUGIN_VERSION;
	}

	@Override
	public Date getAlgorithmPublicationDate() {
		return OmegaTrackingMeasuresMobilityPluginConstants.PLUGIN_PUBL;
	}

	@Override
	public String getDescription() {
		return OmegaTrackingMeasuresMobilityPluginConstants.PLUGIN_DESC;
	}

	@Override
	public String getReference() {
		return OmegaTrackingMeasuresMobilityPluginConstants.PLUGIN_REFERENCE;
	}
