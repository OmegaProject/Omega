package edu.umassmed.omega.omegaTrackingMeasuresMobilityPlugin.runnable;
...
import edu.umassmed.omega.omegaTrackingMeasuresMobilityPlugin.gui.OmegaTrackingMeasuresMobilityGraphPanel;

public class OmegaTrackingMeasuresMobilityGraphProducer extends StatsGraphProducer {

	private final OmegaTrackingMeasuresMobilityGraphPanel mobilityPanel;
	...
	public OmegaTrackingMeasuresMobilityGraphProducer(
			final OmegaTrackingMeasuresMobilityGraphPanel mobilityPanel,
			final int graphType,
	...
	public String getTitle() {
		...
		switch (this.mobilityOption) {
			case OmegaTrackingMeasuresMobilityGraphPanel.OPTION_MAX_DISP_GLO:
				title = GraphLabelConstants.GRAPH_NAME_MAX_DISP_GLO;
				break;
			case OmegaTrackingMeasuresMobilityGraphPanel.OPTION_TOT_DISP_GLO:
				title = GraphLabelConstants.GRAPH_NAME_DISP_GLO;
				break;
			case OmegaTrackingMeasuresMobilityGraphPanel.OPTION_TOT_TIME_GLO:
				title = GraphLabelConstants.GRAPH_NAME_TIME_GLO;
				break;
			case OmegaTrackingMeasuresMobilityGraphPanel.OPTION_CONFRATIO_GLO:
				title = GraphLabelConstants.GRAPH_NAME_CONFRATIO_GLO;
				break;
			case OmegaTrackingMeasuresMobilityGraphPanel.OPTION_DIST_P2P_LOC:
				title = GraphLabelConstants.GRAPH_NAME_DIST_P2P_LOC;
				break;
			case OmegaTrackingMeasuresMobilityGraphPanel.OPTION_DIST_LOC:
				title = GraphLabelConstants.GRAPH_NAME_DIST_LOC;
				break;
			case OmegaTrackingMeasuresMobilityGraphPanel.OPTION_DISP_LOC:
				title = GraphLabelConstants.GRAPH_NAME_DISP_LOC;
				break;
			case OmegaTrackingMeasuresMobilityGraphPanel.OPTION_CONFRATIO_LOC:
				title = GraphLabelConstants.GRAPH_NAME_CONFRATIO_LOC;
				break;
			case OmegaTrackingMeasuresMobilityGraphPanel.OPTION_ANGLES_LOC:
				title = GraphLabelConstants.GRAPH_NAME_ANGLES_LOC;
				break;
			case OmegaTrackingMeasuresMobilityGraphPanel.OPTION_DIRCHANGE_LOC:
				title = GraphLabelConstants.GRAPH_NAME_DIRCHANGE_LOC;
				break;
			case OmegaTrackingMeasuresMobilityGraphPanel.OPTION_TIME_LOC:
	...
	public String getYAxisTitle() {
		...
		switch (this.mobilityOption) {
			...
			case OmegaTrackingMeasuresMobilityGraphPanel.OPTION_CONFRATIO_LOC:
				...
				break;
			case OmegaTrackingMeasuresMobilityGraphPanel.OPTION_TOT_DIST_GLO:
			case OmegaTrackingMeasuresMobilityGraphPanel.OPTION_DIST_P2P_LOC:
			case OmegaTrackingMeasuresMobilityGraphPanel.OPTION_DIST_LOC:
		...
		if (this.itsLocal) {
			...
			try {
				SwingUtilities.invokeAndWait(new Runnable() {
					@Override
					public void run() {
						OmegaTrackingMeasuresMobilityGraphProducer.this.mobilityPanel.updateStatus(
								OmegaTrackingMeasuresMobilityGraphProducer.this.getCompleted(), ended);
					}
				});
