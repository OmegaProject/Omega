...
public class MosaicOmegaFeaturePointTrackerRunPanel extends GenericPanel implements
	...
	public MosaicOmegaFeaturePointTrackerRunPanel(final RootPaneContainer parent,
	...
	private JPanel createDetectionParamPanel() {
		...
		radius_lbl.setPreferredSize(MosaicOmegaFeaturePointTrackerRunPanel.LBL_FIELDS_DIM);
		radiusPanel.add(radius_lbl);
		this.radius_txtField = new GenericTextFieldValidable(
				GenericTextFieldValidable.CONTENT_INT);
		this.radius_txtField.setPreferredSize(MosaicOmegaFeaturePointTrackerRunPanel.VALUE_FIELDS_DIM);
		...
		cutoff_lbl.setPreferredSize(MosaicOmegaFeaturePointTrackerRunPanel.LBL_FIELDS_DIM);
		cutoffPanel.add(cutoff_lbl);
		this.cutoff_txtField = new GenericTextFieldValidable(
				GenericTextFieldValidable.CONTENT_DOUBLE);
		this.cutoff_txtField.setPreferredSize(MosaicOmegaFeaturePointTrackerRunPanel.VALUE_FIELDS_DIM);
		...
		percentile_lbl.setPreferredSize(MosaicOmegaFeaturePointTrackerRunPanel.LBL_FIELDS_DIM);
		percentilePanel.add(percentile_lbl);
		this.percentile_txtField = new GenericTextFieldValidable(
				GenericTextFieldValidable.CONTENT_DOUBLE);
		this.percentile_txtField.setPreferredSize(MosaicOmegaFeaturePointTrackerRunPanel.VALUE_FIELDS_DIM);
	...
	private JPanel createLinkingParamPanel() {
		...
		linkrange_lbl.setPreferredSize(MosaicOmegaFeaturePointTrackerRunPanel.LBL_FIELDS_DIM);
		linkrangePanel.add(linkrange_lbl);
		this.linkrange_txtField = new GenericTextFieldValidable(
				GenericTextFieldValidable.CONTENT_INT);
		this.linkrange_txtField.setPreferredSize(MosaicOmegaFeaturePointTrackerRunPanel.VALUE_FIELDS_DIM);
		...
		displacement_lbl.setPreferredSize(MosaicOmegaFeaturePointTrackerRunPanel.LBL_FIELDS_DIM);
		displacementPanel.add(displacement_lbl);
		this.displacement_txtField = new GenericTextFieldValidable(
				GenericTextFieldValidable.CONTENT_DOUBLE);
		this.displacement_txtField
				.setPreferredSize(MosaicOmegaFeaturePointTrackerRunPanel.VALUE_FIELDS_DIM);
	...
	private JPanel createAdditionalParamPanel() {
		...
		minPointsLbl.setPreferredSize(MosaicOmegaFeaturePointTrackerRunPanel.LBL_FIELDS_DIM);
		minPointsPanel.add(minPointsLbl);
		this.minPoints_txtField = new GenericTextFieldValidable(
				GenericTextFieldValidable.CONTENT_INT);
		this.minPoints_txtField.setPreferredSize(MosaicOmegaFeaturePointTrackerRunPanel.VALUE_FIELDS_DIM);
		...
		zSectionLbl.setPreferredSize(MosaicOmegaFeaturePointTrackerRunPanel.LBL_FIELDS_DIM);
		zSectionPanel.add(zSectionLbl);
		this.zSection_txtField = new GenericTextFieldValidable(
				GenericTextFieldValidable.CONTENT_INT);
		this.zSection_txtField.setPreferredSize(MosaicOmegaFeaturePointTrackerRunPanel.VALUE_FIELDS_DIM);
	...
	public List<OmegaParameter> getSPTParameters() {
		...
		// params.add(new OmegaParameter(MosaicOmegaFeaturePointTrackerPluginConstants.PARAM_CHANNEL, channel));
		return params;
	}
