...
public class SDRunPanel extends GenericPanel implements
	...
	public SDRunPanel(final RootPaneContainer parent,
	...
	private JScrollPane createDetectionParamPanel() {
		...
		final JLabel percentileAbs_lbl = new JLabel(
				OmegaConstantsAlgorithmParameters.PARAM_PERCENTILE_ABS + ":");
	...
	public String[] getParametersError() {
		...
		if (!this.zSection_txtField.isContentValidated()) {
			errors[3] = OmegaConstantsAlgorithmParameters.PARAM_ZSECTION + ": "
