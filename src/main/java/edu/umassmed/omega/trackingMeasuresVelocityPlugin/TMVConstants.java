...
public class TMVConstants {
	...
	public static final String PLUGIN_DESC = "This is the default OMEGA plugin to estimate and plot velocity measures associated with identified trajectories. It utilizes the Trajectory Manager graphical user interface to facilitate the visualization and selection of individual trajectories to be subjected to analysis.";
