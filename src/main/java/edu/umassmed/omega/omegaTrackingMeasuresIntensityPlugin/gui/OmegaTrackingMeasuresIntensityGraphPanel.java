...
import edu.umassmed.omega.omegaTrackingMeasuresIntensityPlugin.runnable.OmegaTrackingMeasuresIntensityGraphProducer;

public class OmegaTrackingMeasuresIntensityGraphPanel extends GenericPanel {
	...
	private OmegaTrackingMeasuresIntensityGraphProducer graphProducer;
	
	private boolean handlingEvent;

	private int lineSize, shapeSize;

	public OmegaTrackingMeasuresIntensityGraphPanel(final RootPaneContainer parent,
	...
	private void createAndAddWidgets() {
		...
		// this.yAxis_cmb.addItem(OmegaTrackingMeasuresIntensityPluginConstants.GRAPH_NAME_INT_PEAK);
		// this.yAxis_cmb.addItem(OmegaTrackingMeasuresIntensityPluginConstants.GRAPH_NAME_INT_CENT);
	...
	private void addListeners() {
		this.globalOrLocal_cmb.addActionListener(new ActionListener() {
			...
			public void actionPerformed(final ActionEvent evt) {
				OmegaTrackingMeasuresIntensityGraphPanel.this.handleChangeResultsType();
			}
		});
		this.xAxis_cmb.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(final ActionEvent evt) {
				OmegaTrackingMeasuresIntensityGraphPanel.this.handleChangeAxis();
			}
		});
		...
		this.drawGraph_btt.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(final ActionEvent e) {
				OmegaTrackingMeasuresIntensityGraphPanel.this.handleDrawChart();
			}
		});
		this.addComponentListener(new ComponentAdapter() {
			@Override
			public void componentResized(final ComponentEvent evt) {
				OmegaTrackingMeasuresIntensityGraphPanel.this.handleComponentResized();
			}
		});
	}
	...
	private void handleDrawTimepointsChart() {
		...
		if (yAxisSelection.equals(GraphLabelConstants.PEAK_INTENSITY_LOC)) {
			this.handleTimepointsChart(OmegaTrackingMeasuresIntensityGraphPanel.OPTION_PEAK_SIGNAL);
		} else if (yAxisSelection
				.equals(GraphLabelConstants.CENTROID_INTENSITY_LOC)) {
			this.handleTimepointsChart(OmegaTrackingMeasuresIntensityGraphPanel.OPTION_CENTROID_SIGNAL);
		} else if (yAxisSelection
				.equals(GraphLabelConstants.MEAN_INTENSITY_LOC)) {
			this.handleTimepointsChart(OmegaTrackingMeasuresIntensityGraphPanel.OPTION_MEAN_SIGNAL);
		} else if (yAxisSelection.equals(GraphLabelConstants.BACKGROUND_LOC)) {
			this.handleTimepointsChart(OmegaTrackingMeasuresIntensityGraphPanel.OPTION_BACKGROUND);
		} else if (yAxisSelection.equals(GraphLabelConstants.NOISE_LOC)) {
			this.handleTimepointsChart(OmegaTrackingMeasuresIntensityGraphPanel.OPTION_NOISE);
		} else if (yAxisSelection.equals(GraphLabelConstants.SNR_LOC)) {
			this.handleTimepointsChart(OmegaTrackingMeasuresIntensityGraphPanel.OPTION_SNR);
		} else if (yAxisSelection.equals(GraphLabelConstants.AREA_LOC)) {
			this.handleTimepointsChart(OmegaTrackingMeasuresIntensityGraphPanel.OPTION_AREA);
		}
	}
	...
	private void handleDrawTracksChart() {
		...
		if (yAxisSelection.equals(GraphLabelConstants.MIN_PEAK_INTENSITY_GLO)) {
			this.handleTracksChart(OmegaTrackingMeasuresIntensityGraphPanel.OPTION_PEAK_SIGNAL,
					OmegaTrackingMeasuresIntensityGraphPanel.OPTION_MIN);
		} else if (yAxisSelection
				.equals(GraphLabelConstants.AVG_PEAK_INTENSITY_GLO)) {
			this.handleTracksChart(OmegaTrackingMeasuresIntensityGraphPanel.OPTION_PEAK_SIGNAL,
					OmegaTrackingMeasuresIntensityGraphPanel.OPTION_MEAN);
		} else if (yAxisSelection
				.equals(GraphLabelConstants.MAX_PEAK_INTENSITY_GLO)) {
			this.handleTracksChart(OmegaTrackingMeasuresIntensityGraphPanel.OPTION_PEAK_SIGNAL,
					OmegaTrackingMeasuresIntensityGraphPanel.OPTION_MAX);
		} else if (yAxisSelection
				.equals(GraphLabelConstants.MIN_CENTROID_INTENSITY_GLO)) {
			this.handleTracksChart(OmegaTrackingMeasuresIntensityGraphPanel.OPTION_CENTROID_SIGNAL,
					OmegaTrackingMeasuresIntensityGraphPanel.OPTION_MIN);
		} else if (yAxisSelection
			...
			this.handleTracksChart(OmegaTrackingMeasuresIntensityGraphPanel.OPTION_MEAN_SIGNAL,
					OmegaTrackingMeasuresIntensityGraphPanel.OPTION_MIN);
		} else if (yAxisSelection
			...
			this.handleTracksChart(OmegaTrackingMeasuresIntensityGraphPanel.OPTION_BACKGROUND,
					OmegaTrackingMeasuresIntensityGraphPanel.OPTION_MIN);
		} else if (yAxisSelection
			...
			this.handleTracksChart(OmegaTrackingMeasuresIntensityGraphPanel.OPTION_NOISE,
					OmegaTrackingMeasuresIntensityGraphPanel.OPTION_MIN);
			...
			this.handleTracksChart(OmegaTrackingMeasuresIntensityGraphPanel.OPTION_SNR,
					OmegaTrackingMeasuresIntensityGraphPanel.OPTION_MIN);
			...
			this.handleTracksChart(OmegaTrackingMeasuresIntensityGraphPanel.OPTION_AREA,
					OmegaTrackingMeasuresIntensityGraphPanel.OPTION_MIN);
	...
	private void handleTracksChart(final int peakMeanBgSnrOption,
		...
		final OmegaTrackingMeasuresIntensityGraphProducer graphProducer = new OmegaTrackingMeasuresIntensityGraphProducer(this,
	...
	private void launchGraphProducerThread(final OmegaTrackingMeasuresIntensityGraphProducer graphProducer) {
	...
	public void updateSelectedTrackingMeasuresRun(
		...
		// this.yAxis_cmb.removeItem(OmegaTrackingMeasuresIntensityPluginConstants.MAX_MEAN_INTENSITY);
		// this.yAxis_cmb.removeItem(OmegaTrackingMeasuresIntensityPluginConstants.AVG_MEAN_INTENSITY);
		// this.yAxis_cmb.removeItem(OmegaTrackingMeasuresIntensityPluginConstants.MIN_MEAN_INTENSITY);
		// this.yAxis_cmb.removeItem(OmegaTrackingMeasuresIntensityPluginConstants.MAX_NOISE);
		// this.yAxis_cmb.removeItem(OmegaTrackingMeasuresIntensityPluginConstants.AVG_NOISE);
		// this.yAxis_cmb.removeItem(OmegaTrackingMeasuresIntensityPluginConstants.MIN_NOISE);
		// this.yAxis_cmb.removeItem(OmegaTrackingMeasuresIntensityPluginConstants.MAX_SNR);
		// this.yAxis_cmb.removeItem(OmegaTrackingMeasuresIntensityPluginConstants.AVG_SNR);
		// this.yAxis_cmb.removeItem(OmegaTrackingMeasuresIntensityPluginConstants.MIN_SNR);
		// this.yAxis_cmb.removeItem(OmegaTrackingMeasuresIntensityPluginConstants.MAX_AREA);
		// this.yAxis_cmb.removeItem(OmegaTrackingMeasuresIntensityPluginConstants.AVG_AREA);
		// this.yAxis_cmb.removeItem(OmegaTrackingMeasuresIntensityPluginConstants.MIN_AREA);
		// if ((this.selectedTrackingMeasuresRun != null)
		// && (this.selectedTrackingMeasuresRun.getSNRRun() != null)) {
		// this.yAxis_cmb.addItem(OmegaTrackingMeasuresIntensityPluginConstants.MAX_MEAN_INTENSITY);
		// this.yAxis_cmb.addItem(OmegaTrackingMeasuresIntensityPluginConstants.AVG_MEAN_INTENSITY);
		// this.yAxis_cmb.addItem(OmegaTrackingMeasuresIntensityPluginConstants.MIN_MEAN_INTENSITY);
		// this.yAxis_cmb.addItem(OmegaTrackingMeasuresIntensityPluginConstants.MAX_NOISE);
		// this.yAxis_cmb.addItem(OmegaTrackingMeasuresIntensityPluginConstants.AVG_NOISE);
		// this.yAxis_cmb.addItem(OmegaTrackingMeasuresIntensityPluginConstants.MIN_NOISE);
		// this.yAxis_cmb.addItem(OmegaTrackingMeasuresIntensityPluginConstants.MAX_SNR);
		// this.yAxis_cmb.addItem(OmegaTrackingMeasuresIntensityPluginConstants.AVG_SNR);
		// this.yAxis_cmb.addItem(OmegaTrackingMeasuresIntensityPluginConstants.MIN_SNR);
		// this.yAxis_cmb.addItem(OmegaTrackingMeasuresIntensityPluginConstants.MAX_AREA);
		// this.yAxis_cmb.addItem(OmegaTrackingMeasuresIntensityPluginConstants.AVG_AREA);
		// this.yAxis_cmb.addItem(OmegaTrackingMeasuresIntensityPluginConstants.MIN_AREA);
		// }
		this.handleDrawChartLater();
	}
