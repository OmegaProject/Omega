...
import edu.umassmed.omega.omegaTrackingMeasuresDiffusivityPlugin.gui.OmegaTrackingMeasuresDiffusivityGraphPanel;

public class OmegaTrackingMeasuresDiffusivityGraphProducer extends StatsGraphProducer {
	
	private final OmegaTrackingMeasuresDiffusivityGraphPanel diffusivityPanel;
	...
	public OmegaTrackingMeasuresDiffusivityGraphProducer(
			final OmegaTrackingMeasuresDiffusivityGraphPanel diffusivityPanel,
			final int graphType,
	...
	public String getTitle() {
		String title = "";
		switch (this.diffusivityOption) {
			case OmegaTrackingMeasuresDiffusivityGraphPanel.OPTION_TRACK_SLOPE_MSS:
				title = GraphLabelConstants.GRAPH_NAME_MSS;
				break;
			case OmegaTrackingMeasuresDiffusivityGraphPanel.OPTION_TRACK_D:
				title = GraphLabelConstants.GRAPH_NAME_DIFF;
				break;
			case OmegaTrackingMeasuresDiffusivityGraphPanel.OPTION_TRACK_ERROR_D:
				title = GraphLabelConstants.GRAPH_NAME_UNCERT_D;
				break;
			case OmegaTrackingMeasuresDiffusivityGraphPanel.OPTION_TRACK_ERROR_SMSS:
		...
		if (this.itsLocal) {
			...
			try {
				SwingUtilities.invokeAndWait(new Runnable() {
					@Override
					public void run() {
						OmegaTrackingMeasuresDiffusivityGraphProducer.this.diffusivityPanel.updateStatus(
								OmegaTrackingMeasuresDiffusivityGraphProducer.this.getCompleted(), ended);
					}
				});
