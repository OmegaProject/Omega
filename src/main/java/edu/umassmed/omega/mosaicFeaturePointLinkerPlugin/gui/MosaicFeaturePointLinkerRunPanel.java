...
public class MosaicFeaturePointLinkerRunPanel extends GenericPanel {
	...
	public MosaicFeaturePointLinkerRunPanel(final RootPaneContainer parent, final OmegaGateway gateway) {
		super(parent);
	...
	public JScrollPane createLinkingParamPanel() {
		...
		linkrange_lbl.setPreferredSize(MosaicFeaturePointLinkerRunPanel.LBL_FIELDS_DIM);
		...
		this.linkrange_txtField.setPreferredSize(MosaicFeaturePointLinkerRunPanel.VALUE_FIELDS_DIM);
		...
		displacement_lbl.setPreferredSize(MosaicFeaturePointLinkerRunPanel.LBL_FIELDS_DIM);
		...
		this.displacement_txtField
				.setPreferredSize(MosaicFeaturePointLinkerRunPanel.VALUE_FIELDS_DIM);
		...
		dynamics_lbl.setPreferredSize(MosaicFeaturePointLinkerRunPanel.LBL_FIELDS_DIM);
		movTypePanel.add(dynamics_lbl);
		this.dynamics_combo = new GenericComboBox<String>(
				this.getParentContainer());
		this.dynamics_combo.addItem(MosaicFeaturePointLinkerPluginConstants.PARAM_MOVTYPE_BROWNIAN);
		this.dynamics_combo.addItem(MosaicFeaturePointLinkerPluginConstants.PARAM_MOVTYPE_STRAIGHT);
		this.dynamics_combo.addItem(MosaicFeaturePointLinkerPluginConstants.PARAM_MOVTYPE_COSVEL);
		this.dynamics_combo.setPreferredSize(MosaicFeaturePointLinkerRunPanel.LBL_FIELDS_DIM);
		...
		objectFeature_lbl.setPreferredSize(MosaicFeaturePointLinkerRunPanel.LBL_FIELDS_DIM);
		...
		radius_lbl.setPreferredSize(MosaicFeaturePointLinkerRunPanel.LBL_FIELDS_DIM);
		dynamicsPanel.add(radius_lbl);
		this.dynamics_txtField = new GenericTextFieldValidable(
				GenericTextFieldValidable.CONTENT_FLOAT);
		this.dynamics_txtField.setPreferredSize(MosaicFeaturePointLinkerRunPanel.VALUE_FIELDS_DIM);
		...
		optimizer_lbl.setPreferredSize(MosaicFeaturePointLinkerRunPanel.LBL_FIELDS_DIM);
		optimizerPanel.add(optimizer_lbl);
		this.optimizer_combo = new GenericComboBox<String>(
				this.getParentContainer());
		this.optimizer_combo.addItem(MosaicFeaturePointLinkerPluginConstants.PARAM_OPTIMIZER_GREEDY);
		this.optimizer_combo.addItem(MosaicFeaturePointLinkerPluginConstants.PARAM_OPTIMIZER_HUNGARIAN);
		this.optimizer_combo.setPreferredSize(MosaicFeaturePointLinkerRunPanel.LBL_FIELDS_DIM);
		...
		minPointsLbl.setPreferredSize(MosaicFeaturePointLinkerRunPanel.LBL_FIELDS_DIM);
		minPointsPanel.add(minPointsLbl);
		this.minPoints_txtField = new GenericTextFieldValidable(
				GenericTextFieldValidable.CONTENT_INT);
		this.minPoints_txtField.setPreferredSize(MosaicFeaturePointLinkerRunPanel.VALUE_FIELDS_DIM);
	...
	public void updateRunFieldsDefault() {
		...
		this.dynamics_combo.setSelectedItem(MosaicFeaturePointLinkerPluginConstants.PARAM_MOVTYPE_BROWNIAN);
		...
		this.optimizer_combo
				.setSelectedItem(MosaicFeaturePointLinkerPluginConstants.PARAM_OPTIMIZER_GREEDY);
	}
