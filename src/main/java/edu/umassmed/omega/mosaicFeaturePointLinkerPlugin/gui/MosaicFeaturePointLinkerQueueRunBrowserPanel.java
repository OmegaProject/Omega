...
public class MosaicFeaturePointLinkerQueueRunBrowserPanel extends GenericPanel {
	...
	public MosaicFeaturePointLinkerQueueRunBrowserPanel(final RootPaneContainer parentContainer,
			final MosaicFeaturePointLinkerPluginPanel sptPanel) {
	...
	private void addListeners() {
		this.dataTree.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(final MouseEvent event) {
				MosaicFeaturePointLinkerQueueRunBrowserPanel.this.handleMouseClick(event.getPoint());
			}
		});
		this.dataTree.getModel().addTreeModelListener(new TreeModelListener() {
			@Override
			public void treeNodesChanged(final TreeModelEvent event) {
				MosaicFeaturePointLinkerQueueRunBrowserPanel.this.handleTreeChanged(event);
			}
