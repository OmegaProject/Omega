...
public class OmegaTrajectoryEditingPluginConstants {
	...
	public static final String PLUGIN_DESC = "This is the default Trajectory Editing plugin provided by OMEGA. It utilizes the Trajectory Browser graphical user interface to facilitate the visualization and selection of individual trajectories and their inspection in the context of the image of origin. Once selected, the plugin allows to edit individual links when necessary.";
