...
public class OmegaTrajectorySegmentationTrackDisplayPanel extends GenericPanel {
	
	private static final long serialVersionUID = -786876453205164899L;
	
	private final OmegaTrajectorySegmentationTrackPanel trackPanel;
	...
	public OmegaTrajectorySegmentationTrackDisplayPanel(final RootPaneContainer parent,
			final OmegaTrajectorySegmentationTrackPanel tsTrackPanel, final int radius,
	...
	private void addListeners() {
		...
		this.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(final MouseEvent evt) {
				OmegaTrajectorySegmentationTrackDisplayPanel.this.handleMouseIn(evt.getPoint());
			}
			
			@Override
			public void mouseExited(final MouseEvent e) {
				OmegaTrajectorySegmentationTrackDisplayPanel.this.handleMouseOut();
			}
		});
		this.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(final MouseEvent evt) {
				OmegaTrajectorySegmentationTrackDisplayPanel.this.handleMouseMotion(evt.getPoint());
			}
		});
	}
	...
	private boolean drawLabels(final Graphics2D g2D, final String label,
		...
		final int dist = OmegaTrajectorySegmentationTrackPanel.SPACE_BETWEEN_LABELS / 3;
		final int dist2 = OmegaTrajectorySegmentationTrackPanel.SPACE_BETWEEN_LABELS;
