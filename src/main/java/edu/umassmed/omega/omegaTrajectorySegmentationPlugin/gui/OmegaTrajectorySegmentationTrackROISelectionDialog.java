...
public class OmegaTrajectorySegmentationTrackROISelectionDialog extends GenericDialog {
	...
	public OmegaTrajectorySegmentationTrackROISelectionDialog(final RootPaneContainer parentContainer,
			final List<OmegaROI> availableROIs) {
		super(parentContainer, OmegaTrajectorySegmentationPluginConstants.ROI_SELECT_DIALOG, true);
	...
	protected void createAndAddWidgets() {
		final JLabel lbl = new JLabel(OmegaTrajectorySegmentationPluginConstants.ROI_SELECT_DIALOG_MSG);
		...
		this.ok_btt = new JButton(OmegaTrajectorySegmentationPluginConstants.ROI_SELECT_OK);
	...
	protected void addListeners() {
		this.ok_btt.addActionListener(new ActionListener() {
			...
			public void actionPerformed(final ActionEvent e) {
				OmegaTrajectorySegmentationTrackROISelectionDialog.this.setVisible(false);
			}
		});
		this.list.addListSelectionListener(new ListSelectionListener() {
			@Override
			public void valueChanged(final ListSelectionEvent evt) {
				final int index = OmegaTrajectorySegmentationTrackROISelectionDialog.this.list
						.getSelectedIndex();
				OmegaTrajectorySegmentationTrackROISelectionDialog.this.roi = OmegaTrajectorySegmentationTrackROISelectionDialog.this.availableROIs
						.get(index);
			}
		});
	}
	...
	private void createAndSetListModel() {
		final ListModel<String> model = new DefaultListModel<String>() {
			...
			@Override
			public int getSize() {
				return OmegaTrajectorySegmentationTrackROISelectionDialog.this.availableROIs.size();
			}
			
			@Override
			public String getElementAt(final int index) {
				final OmegaROI roi = OmegaTrajectorySegmentationTrackROISelectionDialog.this.availableROIs
						.get(index);
				...
				buf.append(OmegaTrajectorySegmentationPluginConstants.ROI_SELECT_FRAMEINDEX);
				buf.append(roi.getFrameIndex());
				buf.append(OmegaTrajectorySegmentationPluginConstants.ROI_SELECT_X);
				buf.append(x);
				buf.append(OmegaTrajectorySegmentationPluginConstants.ROI_SELECT_Y);
				buf.append(y);
				return buf.toString();
			}
