package edu.umassmed.omega.omegaTrajectorySegmentationPlugin.actions;
...
public class OmegaTrajectorySegmentationAction {
	...
	public OmegaTrajectorySegmentationAction(final OmegaTrajectory traj,
